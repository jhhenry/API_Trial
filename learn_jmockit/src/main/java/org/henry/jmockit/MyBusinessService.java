...
public final class MyBusinessService
{
	...
	private void persist(EntityX data2) {
		Database.persist(data2);
	}

	private List<EntityX> find(String string, String someProperty) {
		return Database.find(string, someProperty);
	}
